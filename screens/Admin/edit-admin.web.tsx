...
const EditAdminWeb = () => {
  ...
  // Fetch admin data on component mount or ID change
  useEffect(() => {
  ...
  if (error && !admin) { // Show error if initial data fetch failed and no admin data is available
    return (
      <SafeAreaView className={`flex-1 items-center justify-center ${isDarkMode ? 'bg-[#121212]' : 'bg-white'}`}>
